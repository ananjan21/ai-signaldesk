...
async function handleChat(req, res) {
  ...
  const systemPrompt = [
    ...
    "Keep formatting clean: short paragraphs, bullets, and compact tables only when they improve comparison. Do not repeat duplicate headings.",
    "Use short bold section labels instead of Markdown heading markers. Never output lines beginning with #, ##, ###, or ####.",
    "Use descriptive markdown links such as [OpenAlex paper](URL). Never place a naked URL alone inside parentheses.",
